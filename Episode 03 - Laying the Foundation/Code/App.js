...
// Parcel is Transpiling this code, means Parcel Manages Transpiling the code which is done By the Package known as Babel. 
//Babel is a Transpiler - A source-to-source translator, source-to-source compiler (S2S compiler), transcompiler,
// or transpiler is a type of translator that takes the source code of a program written in a programming language as its input and produces an equivalent source code in the same or a different programming language.

// * JSX => Transpiled to React.createElement => React.JS Object = will be converted to HTMLElement on render(render)
const jsxHeading = <h1 id="heading">Namaste React Using JSX🚀</h1>;

console.log(jsxHeading); // both out put of console log is same
